...
function resolveActivityAuditRecordLocation(entry = null) {
  ...
  const routeMap = {
    ...
    vif: { path: '/networking', kind: 'network', cls: 'vif' },
    bond: { path: '/networking', kind: 'network', cls: 'bond' },
    vlan: { path: '/networking', kind: 'network', cls: 'vlan' },
    ...
    'alert-policy': { path: '/alerts', kind: 'alert-policy', cls: 'alert-policy' },
    'host-target': { path: '/hosts', kind: 'host-target', cls: 'host-target' },
    'managed-target': { path: '/inventory', kind: 'managed-target', cls: 'managed-target' },
