...
const api = {
  ...
  getManagedTargets: () => api.request('GET', '/api/managed-targets'),
  registerManagedTarget: (connectionId, options = {}) => api.request('POST', '/api/managed-targets', { connectionId, enabled: true, ...options }),
  setManagedTargetEnabled: (id, enabled) => api.request('PUT', `/api/managed-targets/${encodeURIComponent(id)}`, { enabled }),
  checkManagedTarget: (id) => api.request('POST', `/api/managed-targets/${encodeURIComponent(id)}/check`),
  ...
  getPermissionGrants: (userId) => api.request('GET', `/api/governance/permissions/${encodeURIComponent(userId)}`),
  savePermissionGrant: (userId, payload) => api.request('PUT', `/api/governance/permissions/${encodeURIComponent(userId)}`, payload),
  removePermissionGrant: (grantId) => api.request('DELETE', `/api/governance/permissions/grants/${encodeURIComponent(grantId)}`),
  getPermissionTemplates: () => api.request('GET', '/api/governance/permission-templates'),
  applyPermissionTemplate: (userId, payload) => api.request('POST', `/api/governance/permissions/${encodeURIComponent(userId)}/apply-template`, payload),
  ...
  getTemplateLibraryItemVersion: (id, version) => api.request('GET', `/api/template-library/items/${encodeURIComponent(id)}/versions/${encodeURIComponent(version)}`),
  restoreTemplateLibraryItemVersion: (id, version) => api.request('POST', `/api/template-library/items/${encodeURIComponent(id)}/versions/${encodeURIComponent(version)}/restore`, {}),
  ...
  getVMPlacementRecommendations: (ref) => api.request('GET', `/api/vms/${encodeURIComponent(ref)}/placement-recommendations`),
  ...
  getNetworkUplinks: () => api.request('GET', '/api/networks/uplinks'),
  getNetworkBonds: () => api.request('GET', '/api/networks/bonds'),
  getNetworkVlans: () => api.request('GET', '/api/networks/vlans'),
  ...
  getOrganizations: () => api.request('GET', '/api/projects/organizations'),
  createOrganization: (payload) => api.request('POST', '/api/projects/organizations', payload),
  deleteOrganization: (id) => api.request('DELETE', `/api/projects/organizations/${encodeURIComponent(id)}`),
  getProjects: () => api.request('GET', '/api/projects'),
  getProject: (id) => api.request('GET', `/api/projects/${encodeURIComponent(id)}`),
  createProject: (payload) => api.request('POST', '/api/projects', payload),
  updateProject: (id, payload) => api.request('PUT', `/api/projects/${encodeURIComponent(id)}`, payload),
  deleteProject: (id) => api.request('DELETE', `/api/projects/${encodeURIComponent(id)}`),
  saveProjectQuota: (id, payload) => api.request('PUT', `/api/projects/${encodeURIComponent(id)}/quotas`, payload),
  setProjectMember: (id, userId, payload) => api.request('PUT', `/api/projects/${encodeURIComponent(id)}/members/${encodeURIComponent(userId)}`, payload),
  getProjectQuotaEvaluation: (id) => api.request('GET', `/api/projects/${encodeURIComponent(id)}/quota-evaluation`),
