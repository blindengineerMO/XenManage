...
const demoDb = {
  ...
  srs: [
    ...
    {
      ref: 'OpaqueRef:sr-demo-iso-1',
      name_label: 'Installer Media ISO Library',
      type: 'nfs',
      content_type: 'iso',
  ...
  isoFiles: {
    'OpaqueRef:sr-demo-iso-1': [
      ...
      { path: 'ubuntu-24.04-server.iso', type: 'file', sizeBytes: 2147483648, modifiedAt: '2026-08-10T09:30:00.000Z' },
      { path: 'drivers', type: 'directory', sizeBytes: 0, modifiedAt: '2026-07-15T08:00:00.000Z' },
      { path: 'drivers/virtio-win.iso', type: 'file', sizeBytes: 536870912, modifiedAt: '2026-07-15T08:00:00.000Z' },
    ],
  },
  networks: [
    {
  ...
  tasks: [
    {
      ...
      error_info: [],
      resident_on: 'OpaqueRef:host-demo-2',
      subtasks: ['OpaqueRef:task-demo-1-sub1', 'OpaqueRef:task-demo-1-sub2'],
    },
    {
      ref: 'OpaqueRef:task-demo-1-sub1',
      uuid: 'task-demo-uuid-1-sub1',
      name_label: 'Pre-migration compatibility check',
      name_description: 'Verifying CPU feature set and network mapping on xen-host-a02',
      status: 'success',
      progress: 1,
      created: '2026-08-19T14:58:10.000Z',
      finished: '2026-08-19T14:59:00.000Z',
      result: 'Compatibility check passed',
      error_info: [],
      resident_on: 'OpaqueRef:host-demo-2',
      subtask_of: 'OpaqueRef:task-demo-1',
    },
    {
      ref: 'OpaqueRef:task-demo-1-sub2',
      uuid: 'task-demo-uuid-1-sub2',
      name_label: 'Post-migration network verification',
      name_description: 'Confirming VIF connectivity after relocation',
      status: 'success',
      progress: 1,
      created: '2026-08-19T15:01:30.000Z',
      finished: '2026-08-19T15:02:00.000Z',
      result: 'Network verification passed',
      error_info: [],
      resident_on: 'OpaqueRef:host-demo-2',
      subtask_of: 'OpaqueRef:task-demo-1',
    },
  ...
  templateLibraryFolders: [
    ...
    { id: 3, parent_id: 2, name: 'cloud-init', owner_user_id: 1, visibility: 'shared', created_at: '2026-08-20T09:05:00.000Z' },
  ],
